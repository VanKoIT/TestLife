...
class QuestionSeeder extends Seeder {
    ...
    public function run() {
        ...
        $questions = [
            ...
            $seeder->insertQuestions('Разработка', [
                ['text' => 'Для чего нужна системная переменная PATH?'],
                ['text' => 'Что такое лог программы?'],
                ['text' => 'Чем отличается текстовый редактор от графического?'],
                ['text' => 'Чем отличается IDE и простой текстовый редактор?'],
                ['text' => 'Что такое кодировка текста?']
            ]),
            $seeder->insertQuestions('Операционные системы', [
                ['text' => 'Что такое операционная система?'],
                ['text' => 'Является ли Android операционной системой?'],
                ['text' => 'Чем отличаются командные строки в Linux, MacOS и Windows?'],
                ['text' => 'Является ли bat расширением исполняемого файла в Windows?'],
            ]),
