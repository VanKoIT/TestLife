...
return [
    ...
    */
    ...
    'email'          => 'Недействительный email адрес',
    ...
    'mimes'     => 'Файл может иметь только расширения :values.',
    ...
    */
    ...
    'custom' => [
        ...
        'name' => [
            ...
            'max' => 'максимальная длина имени :max символов',
        ],
        'email' => [
            'min' => 'email должен содержать не менее :min символов',
            'max' => 'максимальная email :max символов',
